...
function input_user_header() {
    ...
    header_txt += '             <a href="../user/01.html" class="float-end collapse show" id="login_btn"><i class="fa-solid fa-user"></i></a>'
    ...
    header_txt += '                 <li><a href="../main.html">로그아웃</a></li>'
    header_txt += '             </ul>'
    header_txt += '          </div>'
    header_txt += '     </div>'
    header_txt += ' </div>'
...
function show_logout() {
    $('.btns a').toggleClass('show')
    $('.lnb_btn>a').toggleClass('show')
}
...
function input_admin_header() {
    ...
    header_txt += '          </div>'
    header_txt += '          <div class="col btns mt-1 text-end">'
    header_txt += '             <a href="../user/10.html" class="collapse show">로그아웃</a>'
    header_txt += '          </div>'
    header_txt += '     </div>'
    header_txt += ' </div>'
